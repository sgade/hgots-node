...
# Default-Stop:      0 1 6
# Short-Description: Start the HGOTS-Node application
# Description:       A web server that controls a door via usb to serial adapters.
#                    For more info, see https://github.com/sgade/hgots-node.
### END INIT INFO
...
DAEMON_ARGS="/home/pi/hgots-node/src/app"               # path to your node.js server/app
                                            # NB: don't use ~/ in path
 
DESC="HGOTS-node application"                  # whatever fancy description you like
